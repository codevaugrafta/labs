...
func createIcon(size: Int) -> NSImage {
    ...
    let gradient = NSGradient(
        starting: NSColor(white: 1.0, alpha: 0.04),
        ending: NSColor(white: 0, alpha: 0)
    )!
...
let buildDirectory = URL(fileURLWithPath: FileManager.default.currentDirectoryPath, isDirectory: true)
    .appendingPathComponent("build", isDirectory: true)
let iconsetURL = buildDirectory.appendingPathComponent("AppIcon.iconset", isDirectory: true)
...
print("Icon PNGs generated at \(iconsetURL.path)")
